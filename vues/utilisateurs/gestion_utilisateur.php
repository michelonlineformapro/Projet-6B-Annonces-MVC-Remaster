            ...
            <div class="col-sm-12 col-lg-4 mt-2">
                <div id="annonce-card" class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="editer_annonce&id_edit=<?= $data['id_annonce'] ?>" class="btn btn-info">Editer</a>
                        <!--MODAL SUPPRIMER-->
                        <!-- Button trigger modal -->

                        <!--MODAL SUPPRIMER-->
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#supprimer_annonce&id_suppr=<?= $data['id_annonce'] ?>">
                            Supprimer cette annonce
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="supprimer_annonce&id_suppr=<?= $data['id_annonce'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <h3 class="modal-title text-info text-center" id="exampleModalLabel"><?= $data['nom_annonce'] ?></h3>
                                            </li>
                                            <li class="list-group-item text-center">
                                                <img src="~/<?= $data['photo_annonce'] ?>" alt="<?= $data['nom_annonce'] ?>" title="<?= $data['nom_annonce'] ?>" width="50%" class="img-fluid">
                                            </li>
                                            <li class="list-group-item">
                                                <p><b>Description : </b></p>
                                                <p><?= $data['description_annonce'] ?></p>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="supprimer_annonce&id_suppr=<?= $data['id_annonce'] ?>"  type="button" class="btn btn-primary">Confirmer la suppression</a>
                                    </div>
                                </div>
                            </div>
                        </div>
