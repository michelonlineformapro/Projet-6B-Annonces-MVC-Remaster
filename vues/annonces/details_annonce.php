    ...
    <div id="annonce-card" class="card">
        ...
        <div class="card-body">
            ...
            <button type="button" class="btn btn-outline-danger" data-toggle="modal"
                    data-target="#supprimer_annonce&id_suppr=<?= $details['id_annonce'] ?>">
                Supprimer cette annonce
            </button>
            <!--MODAL SUPPRIMER-->
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                    data-target="#editer_annonce&id_suppr=<?= $details['id_annonce'] ?>">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_annonce" class="form-control"
                                                  placeholder="<?= $details['description_annonce'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="prix_annonce"
                                               class="form-control" placeholder="<?= $details['prix_annonce'] ?>"
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="editer_annonce&id_suppr=<?= $details['id_annonce'] ?>" type="button"
            ...
            <div class="modal fade" id="supprimer_annonce&id_suppr=<?= $details['id_annonce'] ?>" tabindex="-1"
                 role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <h3 class="modal-title text-info text-center"
                                        id="exampleModalLabel"><?= $details['nom_annonce'] ?></h3>
                                </li>
                                <li class="list-group-item text-center">
                                    <img src="~/<?= $details['photo_annonce'] ?>"
                                         alt="<?= $details['nom_annonce'] ?>"
                                         title="<?= $details['nom_annonce'] ?>" width="50%" class="img-fluid">
                                </li>
                                <li class="list-group-item">
                                    <p><b>Description : </b></p>
                                    <p><?= $details['description_annonce'] ?></p>
                                ...
                                <li class="list-group-item">
                                    <p><b>Prix : <?= $details['prix_annonce'] ?> €</b></p>
                                </li>
                                <li class="list-group-item">
                                    <p><b>Catégorie : </b><?= $details['type_categorie'] ?></p>
                                </li>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="supprimer_annonce&id_suppr=<?= $details['id_annonce'] ?>" type="button" class="btn btn-primary">Confirmer la suppression</a>
                        </div>
                    </div>
                </div>
            </div>
